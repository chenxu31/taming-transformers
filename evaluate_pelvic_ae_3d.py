...
from taming.models.vqgan import VQModel3D
...
def main(device, args):
    ...
    model = VQModel3D(ddconfig=config.params.ddconfig,
    ...
    if args.modality == "ct":
        ...
        assert 0
    patch_shape = (config.params.ddconfig.resolution, config.params.ddconfig.resolution, config.params.ddconfig.resolution)
